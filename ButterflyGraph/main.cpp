...
bool Graph::butterflyGraph(){
        ...
        for(int i = 0; i < size;i++){
                if((int)Adj[i].size() == 2 && (int)transpose[i].size() == 2){
                        temp++;
                        s = i;
                }
                if(temp > 1){
                ...
                if(i != s && ((int)Adj[i].size() > 1 || (int)transpose[i].size() > 1)){
                        return false;
                }
        }
        if(temp == 0){
...
int main(){
        ...
        while(cin >> command){
                ...
                else if(command == "butterflyGraph"){
                        cout << "Running butterflyGraph." << endl;
                        bool res = ag.butterflyGraph();
                        if(res)
							cout << "The graph is a butterfly graph." << endl;
						else
							cout << "The graph is NOT a butterfly graph." << endl;
                 }                         
                else{
